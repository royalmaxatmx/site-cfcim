...
<!-- chargement du fichier font awesome -->
...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<hgroup>
			<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"> <img src="http://localhost/cfcim/wp-content/uploads/2017/12/logo-cfcim.png" alt="CFCIM"> <?php //bloginfo( 'name' ); ?> </a></h1>
...
</div><!-- fin zone de recherche rajoutée -->
